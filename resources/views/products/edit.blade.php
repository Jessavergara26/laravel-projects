...
<div class="row justify-content-center mt-3">
 ...
 @if($product->image)
 <div class="mb-3 row">
  <label class="col-md-4 col-form-label text-md-end text-start"><strong>Current Image:</strong></label>
  <div class="col-md-6">
 ...
 <div class="mb-3 row">
  <label for="image" class="col-md-4 col-form-label text-md-end text-start">Change Product Image</label>
  <div class="col-md-6">
